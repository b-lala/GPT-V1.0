...
API_KEY = "sk-rwefH6RwYUnwCOuUD27071672b65402aA6D52d8b8e359b9c"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
...
if USE_PROXY:
    ...
    proxies = {
        #          [协议]://  [地址]  :[端口]
        "http":  "http://114.55.245.137:1478",  # 再例如  "http":  "http://127.0.0.1:7890",
        "https": "http://114.55.245.137:1478",  # 再例如  "https": "http://127.0.0.1:7890",
    }
else:
    proxies = None
...
API_URL_REDIRECT = {"https://api.openai.com/v1/chat/completions": "https://api.kwwai.top/v1/chat/completions"}
...
AUTHENTICATION = [("user", "1"),("user2", "2"),("user3", "3"),("wa","1")]
